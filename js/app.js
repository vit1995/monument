 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-foto__slider")) new core(".slider-foto__slider", {
            ...
            if (document.querySelector(".popup-catalog__slider")) new core(".popup-catalog__slider", {
            ...
            if (document.querySelector(".season__slider")) new core(".season__slider", {
                ...
                navigation: {
                    prevEl: ".season__button-prev",
                    nextEl: ".season__button-next"
                },
                on: {}
            });
        }
...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const catalog = document.querySelector(".menu__item--catalog");
            const catalogClose = document.querySelector(".dropdown-menu__close");
            const dropdown = document.querySelector(".dropdown-menu");
            if (!catalog || !catalogClose || !dropdown) {
            ...
            catalog.addEventListener("click", (function(e) {
                e.preventDefault();
                e.stopPropagation();
                document.documentElement.classList.add("active-sub");
            }));
            catalogClose.addEventListener("click", (function(e) {
                e.preventDefault();
                e.stopPropagation();
                document.documentElement.classList.remove("active-sub");
            }));
            document.addEventListener("click", (function(e) {
                if (!dropdown.contains(e.target) && e.target !== catalog) document.documentElement.classList.remove("active-sub");
            }));
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            const menuTitles = document.querySelectorAll(".dropdown-menu__title");
            const html = document.documentElement;
            menuTitles.forEach((title => {
                title.addEventListener("click", (function(e) {
                    e.preventDefault();
                    const list = this.closest(".dropdown-menu__item").querySelector(".dropdown-menu__list");
                    list.classList.add("active");
                    html.classList.add("sub-list");
                }));
            }));
            document.querySelectorAll(".dropdown-menu__close-sub").forEach((btn => {
                btn.addEventListener("click", (function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    const list = this.closest(".dropdown-menu__list");
                    list.classList.remove("active");
                    const activeLists = document.querySelectorAll(".dropdown-menu__list.active");
                    if (0 === activeLists.length) html.classList.remove("sub-list");
                }));
            }));
            document.addEventListener("click", (function(e) {
                if (!e.target.closest(".dropdown-menu")) {
                    document.querySelectorAll(".dropdown-menu__list.active").forEach((list => {
                        list.classList.remove("active");
                    }));
                    html.classList.remove("sub-list");
                }
            }));
        }));
        window["FLS"] = true;
